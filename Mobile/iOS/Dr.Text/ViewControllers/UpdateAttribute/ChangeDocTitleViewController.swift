//
//  ChangeDocTitleViewController.swift
//  Dr.Text
//
...
class ChangeDocTitleViewController: UIViewController, customTextFieldProtocol, promptListDelegate  {
    
    @IBOutlet weak var saveBarBtnItm: UIBarButtonItem!
    @IBOutlet weak var doctorTitles: CustomTextFieldView!
    var degreeList = ["MD", "OD", "LMFT", "LCSW", "PhD", "Psy.D", "CPC", "NP", "PA"]
    ...
    override func viewDidLoad() {
        ...
        doctorTitles.textField.text = Utils.user.doctorTitle!
    ...
    @IBAction func actionOnSaveBtn(_ sender: UIButton) {
        ...
        if Utils.reachability.currentReachabilityStatus != .notReachable {
            ...
            attribute?.name  = "custom:doctorTitle"
            attribute?.value = doctorTitles.textField.text!
    ...
    func updateUserDetails() {
        let user = Utils.user!
        user.doctorTitle = doctorTitles.textField.text!
