...
class DatePickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource
{
    ...
    var custompickerDelegate: customDatePickerDelegate!
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if (self.custompickerDelegate != nil) {
            self.custompickerDelegate.didCustomDatePickerSelectRow(date: Utils.convertStringFromDateForExpDate(date: self.date))
            print(Utils.convertStringFromDateForExpDate(date: self.date))
        }
    }
